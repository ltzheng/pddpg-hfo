...
class Actor(nn.Module):
    ...
    def __init__(self, obs_dim, action_size, action_parameter_size, hidden_layers=None, init_std=0.01,
        ...
        # initialise layers
        self.layers = nn.ModuleList()
        last_hidden_layer_size = self.obs_dim
        if hidden_layers is not None:
            nh = len(hidden_layers)
        ...
        self.action_parameters_passthrough_layer = nn.Linear(self.obs_dim, self.action_parameter_size)
